...
(function($) {
	...
	$.mq900 = 'screen and (min-width: 900px)';
...
// -- 900
	$.vmin900 = {
		match: function(){
			app.obj.$body.addClass('vmin900');
			app.obj.$body.trigger('vmin_900_true');
		},
		unmatch: function(){
			app.obj.$body.removeClass('vmin900');
			app.obj.$body.trigger('vmin_900_false');
		}
	};
// -- 1024
	$.vmin1024 = {
...
// -----
	...
	enquire.register($.mq900, $.vmin900);
